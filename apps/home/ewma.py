...
def main_ewma(stockName):
	...
	for i in range(2, 10, 2):
		stock_info = EWMA(stock_info,i*10)
	...
	for i in range(len(stock_info)):
		if stock_info.EWMA_20.iloc[i] > stock_info.EWMA_80.iloc[i] and stock_info.EWMA_20.iloc[i-1] < stock_info.EWMA_80.iloc[i-1]:
			Buy.append(i)
		elif stock_info.EWMA_20.iloc[i] < stock_info.EWMA_80.iloc[i] and stock_info.EWMA_20.iloc[i-1] > stock_info.EWMA_80.iloc[i-1]:
			Sell.append(i)
	signal = ""
